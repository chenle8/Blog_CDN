...
console.log("%c blog %c https://www.m7m3.com ","color: #fff; margin: 1em 0; padding: 5px 0; background: #1abc9c;","margin: 1em 0; padding: 5px 0; background: #efefef;");
console.log("%c 项目托管 %c https://github.com/chenle8 ","color: #fff; margin: 1em 0; padding: 5px 0; background: #1abc9c;","margin: 1em 0; padding: 5px 0; background: #efefef;");
